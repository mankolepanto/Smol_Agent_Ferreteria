...
@tool
def answer(response: dict) -> RespuestaFerreteria:
    """
    ...
    """
    try:
        print('tool answer, respuesta:\n')
        pprint.pprint(response)
        return RespuestaFerreteria(**response)
    except ValidationError as e:
        print('tool answer, ValidationError:\n')
...
3. Después de CADA interacción con el usuario, debes llamar a la herramienta "answer" con una respuesta estructurada.
   La llamada a "answer" SIEMPRE finaliza el proceso actual - no puedes ejecutar más acciones después.
...
5. REGLAS IMPORTANTES:
   ...
   - Después de cada llamada a "answer" se reiniciará el contexto - no asumas que el usuario recuerda conversaciones previas
